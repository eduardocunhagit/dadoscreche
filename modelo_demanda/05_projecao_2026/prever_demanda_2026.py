...
from modelo_demanda.estimar_escolhas import (
    QUERY_A,
...
from modelo_demanda.rotinas.io import load_query_a

ENVELOPE_DIR = ROOT / "Pedro" / "Modelo" / "insumos_modelo_demanda"
OUT = ROOT / "modelo_demanda" / "06_resultados"
...
def run():
    ...
    evaluation_path = ROOT / "modelo_demanda" / "07_painel" / "public" / "results.json"
